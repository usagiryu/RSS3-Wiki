...
- `uuid` is the UUID 5 generated by namespace as `6ba7b815-9dad-11d1-80b4-00c04fd430c8` and name as `<instance><item_date_created>`, this also means that you cannot post two Custom Items with the same `date_created`.

For example,

- `asset:0xacbe98efe2d4d103e221e04c76d7c55db15c8e89-5@ethereum`
- `note:f55cf7ef-7ffa-5d9f-858e-acdd1d5af78d@rss3`
