...
Only for automatically indexer-generated items. URLs associated with the item, such as the address of the item in the indexed network.

##### 4.5.2.5. `item.identifier` and `item.identifier_instance`
